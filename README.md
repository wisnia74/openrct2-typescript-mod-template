...
# Template:
[![wisnia74](https://circleci.com/gh/wisnia74/openrct2-typescript-mod-template.shield?style=svg)](https://app.circleci.com/pipelines/github/wisnia74/openrct2-typescript-mod-template)
...
- `cd` into it and edit `init.json`
	...
	- `userName`, `modName`, `modType`, `openrct2ApiFilepath` and `openrct2PluginFolderPath` are required to be edited, the rest is optional and comes with defaults
